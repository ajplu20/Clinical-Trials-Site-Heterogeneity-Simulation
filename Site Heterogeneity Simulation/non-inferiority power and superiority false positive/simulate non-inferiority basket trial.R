...
simulate_multiple_trials <- function(
  ...
  for (i in 1:iterations) {
    ...
    results$fix_effect_model_test[i]  <- perform_fix_effect_model_test(trial_data, alpha = 0.05, trial_type = "non-inferiority", basket = TRUE)
    results$mixed_effect_model_test[i]<- perform_mixed_effect_model_test(trial_data, alpha = 0.05, trial_type = "non-inferiority", basket = TRUE)
    results$mantel_haenszel_test[i]   <- perform_mantel_haenszel_test(trial_data, alpha = 0.05, trial_type = "non-inferiority-naive")
    #results$mantel_haenszel_test[i]   <- perform_mantel_haenszel_test(trial_data, alpha = 0.05, trial_type = "non-inferiority")
