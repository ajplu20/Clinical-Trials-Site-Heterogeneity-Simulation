...
simulate_multiple_trials <- function(
  ...
  for (i in 1:iterations) {
    ...
    results$fix_effect_model_test[i]  <- perform_fix_effect_model_test(trial_data,trial_type = "superiority", basket = FALSE)
    results$mixed_effect_model_test[i]<- perform_mixed_effect_model_test(trial_data, trial_type = "superiority", basket = FALSE)
