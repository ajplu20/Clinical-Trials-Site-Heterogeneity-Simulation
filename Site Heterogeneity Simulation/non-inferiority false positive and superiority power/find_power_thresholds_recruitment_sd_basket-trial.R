# basket_recruitmentsd_parallel.R
...
# ---- One task = run ONE recruitment_sd end-to-end (preserves early-stop) ----
run_one_recruitmentsd_basket <- function(
  ...
  data.frame(
    recruitment_sd = recruit_sd,  # <-- correct label
...
run_scenario_recruitmentsd <- function(recruitment_sd_list, total_n, individual_sd, treatment_sd,
